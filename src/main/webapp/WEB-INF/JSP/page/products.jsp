...
<div class="row">
	...
	<div class="text-center hidden-print">
		<img src="/static/img/loading.gif" id="loadMoreIndicator"
		...
		<div class="modal-content">
			...
			<div class="modal-body row">
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="list-group hidden-xs" style="margin-bottom: 10px;">
					...
					<div class="list-group">
						<span class="list-group-item"> <small>Price:</small> <span class="price">0</span></span> <span class="list-group-item"> <small>Count:</small>
